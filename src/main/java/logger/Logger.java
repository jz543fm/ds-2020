...
public class Logger
{
    ...
    public void finish(String caller, int peerID, int port) {
        System.out.println(getTimeFormat()  + " | finish | Terminating " + caller + " [" + peerID + "]" +  " at port [" + port  + "]");
    }


    public void init(String caller, int peerID, int port) {
        System.out.println(getTimeFormat()  + " | init | Running " + caller + " [" + peerID + "]" + " at port [" + port  + "]");
    }


    public void init(String caller) {
        System.out.println(getTimeFormat() + " | init | Running  " + caller);
    }

    public void init(String caller, int peerID) {
        System.out.println(getTimeFormat() + " | init | Running  " + caller + " [" + peerID + "]");
    }


    public void info(String caller, String message) {
        System.out.println(getTimeFormat()  + " | info | " + caller + " | " + message);
    }


    public void info(String caller, int peerID, String message) {
        System.out.println(getTimeFormat()  + " | info | " + caller + " [" + peerID + "]" + " | " + message);
    }
    ...
    public void error(String caller, String message) {
        System.err.println(getTimeFormat() + " | error | " + caller + " | " + message);
    }

    public void error(String caller, int peerID, String message) {
        System.err.println(getTimeFormat() + " | error |  " + caller + " [" + peerID + "]" + " | " + message);
    }
